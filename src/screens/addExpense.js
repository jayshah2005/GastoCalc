...
const AddExpense = () => {
  ...
  <View style={styles.container}>
      ...
      <Input text={'Name Of Expense'} placeholder={'What did you spend on?'} multiline={false} value={Name} onChangeText={text => setName(text)} />
      <Input text={'Expense Amount'} placeholder={'₹ ??'} inputMode={'numeric'} value={Amount} onChangeText={text => setAmount(text)} />
